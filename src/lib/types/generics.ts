...
type ConstArray<T, N extends number> = N extends 0
	? []
	: N extends 3
	? [T, T, T]
	: N extends 8
...
type MaxLengthArray<T, N extends number> = Partial<ConstArray<T, N>>;

export type { RequiredPick, PartialOmit, RequiredAtLeastOne, ConstArray, MaxLengthArray };
